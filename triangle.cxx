...
#ifndef NDEBUG
        std::cerr << "Created graphics pipelines count " << 1 << std::endl;
#endif
...
#ifndef NDEBUG
        std::cerr << "Allocated command buffer count " << 1 << std::endl;
#endif
    }
...
//------------------------------------------------------------
    ...
    void drawFrame()
    {
        ...
        if (vkQueueSubmit(graphicsQueue, 1, &submitInfo, inFlightFence) != VK_SUCCESS)
            throw std::runtime_error("Failed graphics queue submit!");
